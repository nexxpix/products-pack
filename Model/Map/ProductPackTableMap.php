...
namespace ProductsPack\Model\Map;
...
class ProductPackTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ProductsPack.Model.Map.ProductPackTableMap';
     ...
     */
    const OM_CLASS = '\\ProductsPack\\Model\\ProductPack';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ProductsPack.Model.ProductPack';
     ...
     */
    const PACK_ID = 'product_pack.PACK_ID';
    ...
    protected static $fieldNames = array(
        ...
        self::TYPE_RAW_COLNAME   => array('PACK_ID', 'PRODUCT_ID', ),
        self::TYPE_FIELDNAME     => array('pack_id', 'product_id', ),
    ...
    protected static $fieldKeys = array(
        ...
        self::TYPE_RAW_COLNAME   => array('PACK_ID' => 0, 'PRODUCT_ID' => 1, ),
        self::TYPE_FIELDNAME     => array('pack_id' => 0, 'product_id' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ProductsPack\\Model\\ProductPack');
    ...
    {
        $this->addRelation('Pack', '\\ProductsPack\\Model\\Pack', RelationMap::MANY_TO_ONE, array('pack_id' => 'id', ), null, null);
        $this->addRelation('Product', '\\ProductsPack\\Model\\Thelia\\Model\\Product', RelationMap::MANY_TO_ONE, array('product_id' => 'id', ), null, null);
    } // buildRelations()
     ...
     * and findPk*() calls.
     *
     * @param \ProductsPack\Model\ProductPack $obj A \ProductsPack\Model\ProductPack object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize(array((string) $obj->getPackId(), (string) $obj->getProductId()));
            } // if key === null
     ...
     *
     * @param mixed $value A \ProductsPack\Model\ProductPack object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \ProductsPack\Model\ProductPack) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \ProductsPack\Model\ProductPack object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('PackId', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize(array((string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('PackId', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)]));
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ProductPackTableMap::PACK_ID);
