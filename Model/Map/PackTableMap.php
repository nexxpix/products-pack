...
class PackTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ProductsPack.Model.Map.PackTableMap';
     ...
     */
    const OM_CLASS = '\\ProductsPack\\Model\\Pack';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ProductsPack.Model.Pack';
     ...
     */
    const IS_ACTIVE = 'pack.IS_ACTIVE';

    /**
     * the column name for the PRODUCT_ID field
     */
    const PRODUCT_ID = 'pack.PRODUCT_ID';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_RAW_COLNAME   => array('ID', 'IS_ACTIVE', 'PRODUCT_ID', ),
        self::TYPE_FIELDNAME     => array('id', 'is_active', 'product_id', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'IS_ACTIVE' => 1, 'PRODUCT_ID' => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'is_active' => 1, 'product_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ProductsPack\\Model\\Pack');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('ProductPack', '\\ProductsPack\\Model\\ProductPack', RelationMap::ONE_TO_MANY, array('id' => 'pack_id', ), null, null, 'ProductPacks');
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PackTableMap::ID);
            $criteria->addSelectColumn(PackTableMap::IS_ACTIVE);
            $criteria->addSelectColumn(PackTableMap::PRODUCT_ID);
        } else {
