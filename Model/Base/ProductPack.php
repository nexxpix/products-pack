...
abstract class ProductPack implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ProductsPack\\Model\\Map\\ProductPackTableMap';
    ...
    /**
     * Initializes internal state of ProductsPack\Model\Base\ProductPack object.
     */
    ...
    /**
     * Compares this with another <code>ProductPack</code> instance.  If
     * <code>obj</code> is an instance of <code>ProductPack</code>, delegates to
     * <code>equals(ProductPack)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return ProductPack The current object, for fluid interface
     */
     ...
     * @return   \ProductsPack\Model\ProductPack The current object (for fluent API support)
     */
    public function setPackId($v)
    {
        ...
        if ($this->pack_id !== $v) {
            $this->pack_id = $v;
            $this->modifiedColumns[ProductPackTableMap::PACK_ID] = true;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[ProductPackTableMap::PRODUCT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductPackTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProductPackQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProductPack::setDeleted()
     * @see ProductPack::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildProductPackQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProductPackTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO product_pack (%s) VALUES (%s)',
    ...
    {
        $pos = ProductPackTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProductPack'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProductPack'][serialize($this->getPrimaryKey())] = true;
        $keys = ProductPackTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getPackId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aPack) {
                $result['Pack'] = $this->aPack->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ProductsPack\Model\ProductPack (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \ProductsPack\Model\ProductPack Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPack(ConnectionInterface $con = null)
    {
        if ($this->aPack === null && ($this->pack_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPack->addProductPacks($this);
             */
        }
    ...
    public function getProduct(ConnectionInterface $con = null)
    {
        if ($this->aProduct === null && ($this->product_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProduct->addProductPacks($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProductPackTableMap::DEFAULT_STRING_FORMAT);
    }
